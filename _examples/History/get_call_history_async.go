...
func main() {
	...
	params := methods.GetCallHistoryAsyncParams{FromDate: FromDate, ToDate: ToDate, Timezone: "Etc/GMT", WithCalls: WithCalls, WithRecords: WithRecords, Output: "csv"}
	res, verr, err := client.History.GetCallHistoryAsync(params)
